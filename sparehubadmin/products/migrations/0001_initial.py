# Generated by Django 5.1.4 on 2025-04-21 10:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('technical_specification_pdf', models.URLField(blank=True)),
                ('installation_guide_pdf', models.URLField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='compatible_cars', to='products.product')),
            ],
            options={
