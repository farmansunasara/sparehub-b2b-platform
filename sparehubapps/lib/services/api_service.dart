...
class ApiService {
  ...
  Future<Map<String, dynamic>> login(String email, String password) async {
    ...
    try {
      ...
      if (response['refresh'] == null) {
        ...
        throw ApiException(message: 'Invalid login response: Missing refresh token', statusCode: 401);
      }
      if (response['user'] == null) {
        _logger.e('No user data in response: $response');
        throw ApiException(message: 'Invalid login response: Missing user data', statusCode: 401);
      }
  ...
  Future<Map<String, dynamic>> updateProduct(String id, Map<String, dynamic> product) async {
    return _handleResponse((headers) => _client.put(
  ...
  Future<Map<String, dynamic>> getProduct(String id) async {
    return _handleResponse((headers) => _client.get(
      Uri.parse('$_baseUrl/products/$id/'),
      headers: headers,
    ));
  }
  ...
  Future<Map<String, dynamic>> updateOrderStatus(String id, String status, {String? comment}) async {
    return _handleResponse((headers) => _client.patch(
  ...
  Future<void> markNotificationAsRead(String id) async {
    await _handleResponse((headers) => _client.patch(
  ...
  Future<void> updateSettings(Map<String, dynamic> settings) async {
    await _handleResponse((headers) => _client.put(
      Uri.parse('$_baseUrl/settings/'),
      headers: headers,
